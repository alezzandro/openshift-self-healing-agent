...
run_step "${SCRIPT_DIR}/09-configure-gitops.sh"
...
echo "  3. Open the OpenShift GitOps (Argo CD) UI for the GitOps track"
echo "  4. Trigger a demo scenario:"
echo "     Infrastructure track:"
echo "       ./demo/infrastructure/scenarios/01-worker-node-failure/trigger.sh"
echo "     GitOps track:"
echo "       ./demo/gitops/scenarios/01-imagepullbackoff-bad-tag/trigger.sh"
echo ""
