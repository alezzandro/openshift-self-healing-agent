...
export SNOW_AAP_USERNAME="${SNOW_AAP_USERNAME:-svc-aap-automation}"
export SNOW_AAP_PASSWORD="${SNOW_AAP_PASSWORD:-}"
export SNOW_AAP_USER_SYSID="${SNOW_AAP_USER_SYSID:-}"
export SNOW_AI_USERNAME="${SNOW_AI_USERNAME:-svc-ai-agent}"
export SNOW_AI_PASSWORD="${SNOW_AI_PASSWORD:-}"
